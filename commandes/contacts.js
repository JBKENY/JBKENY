...
zokou({ nomCom: 'channel',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`https://chat.whatsapp.com/BlYI9Cdy4q2KIbovipzKtO`) 
...
JBKENY ᴏᴡɴᴇʀ sᴀʏs ᴍᴏsᴛ ᴏғ ᴜᴘᴅᴀᴛᴇs ᴀʀᴇ ᴀʀᴏᴜɴᴅ ᴛʜᴇ ᴄᴏʀɴᴇʀ... ʏᴏᴜ ᴡɪʟʟ ᴇɴᴊᴏʏ ᴍᴏʀᴇ ᴄᴏᴍᴍᴀɴᴅs ᴀs ʜᴇ ᴀᴅᴅs ᴛʜᴇᴍ...
...
zokou({ nomCom: 'jbl',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_ JBKENY running...... Love it_*`) 
...
zokou({ nomCom: 'me',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*check the developer via https://wa.me/c/254736512615*`) 
...
Wanna talk to me?👉 https://wa.me/c/254736512615 👈
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
© *jbkeny *`) 
