...
let infoMsg =  `
1.\n> Recipient Name:** 𝐉𝐚𝐜𝐨𝐛 𝐌𝐮𝐬𝐲𝐨𝐤𝐚 𝐌𝐰𝐢𝐥𝐮  
2.\n> Mobile Number:** 0746599745 (Safaricom) 
3.\n> Hello 👋\n${nomAuteurMessage}
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *𝐣𝐛𝐦𝐱𝐦𝐝*, déveloper 𝐣𝐚𝐜𝐨𝐛 𝐓𝐞𝐜𝐡" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
