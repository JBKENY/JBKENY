...
✞ Open this link 👉 https://jbm.onrender.com  then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  254736512615 then tap submit 
✞Queen-m owner , *jbkeny* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that queen-m owner sent you.
✞ After a successful login jbkeny owner 🤔 jbkeny will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
